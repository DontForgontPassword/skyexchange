...
const TradingPairButton = ({
    ...
    isActive,
    onClick,
}: TradingPairsPanelProps) => {
    return (
        <button
            className={clsx("trading-pair", isActive && "trading-pair--active")}
            onClick={onClick}
        >
            ...
            <div className="trading-pair__bottom">
                ...
                <p
                    className={clsx(
                        "trading-pair__change",
                        change >= 0
                            ? "trading-pair__change--positive"
                            : "trading-pair__change--negative"
                    )}
                >
