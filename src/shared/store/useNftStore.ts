...
const NFT_COLLECTION: INft[] = [
     { name: "Extraterrestrial din din madung #4821", rarity: "Legendary", price: 898.45, type: "popular", image: extraterrestrial },
     { name: "Samurai Mashka #7392", rarity: "Rare", price: 112.38, type: "popular", image: digitalPhantom },
     { name: "Kirill Barabulka #1205", rarity: "Legendary", price: 201.77, type: "new", image: kirillBarabulka },
     { name: "Kazah Level Up Super Ultra Max #9451", rarity: "Common", price: 67.12, type: "new", image: cyberGuardian },
     { name: "Chicken Nuggets #3178", rarity: "Epic", price: 144.89, type: "new", image: neonSoul },
     { name: "Quantum Ranger #5823", rarity: "Rare", price: 198.45, type: "popular", image: quantumRanger },
     { name: "Olga #4709", rarity: "Legendary", price: 230.12, type: "popular", image: olga },
     { name: "Femboi Warrior #8632", rarity: "Common", price: 91.77, type: "new", image: femboiWarrior },
     { name: "Bee chlen #218", rarity: "Epic", price: 152.34, type: "popular", image: beeChlen },
     { name: "Kit Igor #7284", rarity: "Legendary", price: 123.67, type: "new", image: kitIgor },
     { name: "Cock Guardian #3443", rarity: "Legendary", price: 1222.67, type: "new", image: cockGuardian },
     { name: "Lady Gaga #4353", rarity: "Legendary", price: 543.67, type: "new", image: ladyGaga },
];
interface INftStore {
     nfts: INft[];
